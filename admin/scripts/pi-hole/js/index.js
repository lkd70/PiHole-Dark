...
// Added simple styling object, makes it easier to customize.
var chartStyle = {
	queryOverTimeChart: {
		totalDNS: {
...
function updateQueryTypes() {
    $.getJSON("api.php?getQueryTypes", function(data) {
        ...
        $.each(data, function(key , value) {
            v.push(value);
            c.push(chartStyle.queryTypeChart.colours.shift());
...
function updateForwardDestinations() {
    $.getJSON("api.php?getForwardDestinations", function(data) {
        ...
        * */
        ...
        $.each(data, function(key , value) {
            v.push(value);
            c.push(chartStyle.forwardDestinationChart.colours.shift());
            if(key.indexOf("|") > -1)
            {
                var idx = key.indexOf("|");
...
$(document).ready(function() {
                ...
                datasets: [
                    {
                        ...
                        fill: true,
                        backgroundColor: chartStyle.queryOverTimeChart.totalDNS.backgroundColor,
                        borderColor: chartStyle.queryOverTimeChart.totalDNS.borderColor,
                        pointBorderColor: chartStyle.queryOverTimeChart.totalDNS.pointBorderColor,
                        pointRadius: 2,
                        pointHoverRadius: 5,
                        data: [],
                        pointHitRadius: 5,
                    ...
                    },
                    {
                        ...
                        fill: true,
                        backgroundColor: chartStyle.queryOverTimeChart.blockedDNS.backgroundColor,
                        borderColor: chartStyle.queryOverTimeChart.blockedDNS.borderColor,
                        pointBorderColor: chartStyle.queryOverTimeChart.blockedDNS.pointBorderColor,
                        pointRadius: 2,
                        pointHoverRadius: 5,
                        data: [],
                        pointHitRadius: 5,
        ...
        if(document.getElementById("queryTypeChart"))
        {
            ...
            queryTypeChart = new Chart(ctx, {
                type: chartStyle.queryTypeChart.type,
                data: {
                    labels: [],
                    datasets: [{ data: [] }]
                },
		...
		elements : {
			arc: {
				borderWidth: chartStyle.queryTypeChart.borderWidth,
				borderColor: chartStyle.queryTypeChart.borderColor
			}
		},
                    legend: {
                        display: false
        ...
        if(document.getElementById("forwardDestinationChart"))
        {
            ...
            forwardDestinationChart = new Chart(ctx, {
                type: chartStyle.forwardDestinationChart.type,
                data: {
                    labels: [],
                    datasets: [{ data: [] }]
                },
		...
		elements : {
			arc: {
				borderWidth: chartStyle.forwardDestinationChart.borderWidth,
				borderColor: chartStyle.forwardDestinationChart.borderColor
			}
		},
                    legend: {
                        display: false
